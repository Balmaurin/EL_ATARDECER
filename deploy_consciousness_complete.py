    ...
    async def start_consciousness_services(self):
        ...
        if self.consciousness_engine:
            try:
                ...
                test_input = {"input": "Hello, I am testing the consciousness system", "modality": "text", "context": {"test": True}}
                result = await asyncio.to_thread(
                    self.consciousness_engine.process_conscious_experience,
                    test_input
                )
                logger.info("✅ Consciousness engine responding")
                logger.info(f"   • System Φ: {result.get('system_phi', 'N/A')}")
...
async def process_conscious_experience(data: ConsciousInputModel):
    if consciousness_engine:
        try:
            result = consciousness_engine.process_conscious_experience(data.dict())
...
'''
        ...
        # Write consciousness API server
        api_path = self.base_path / "consciousness_api_server.py"
        with open(api_path, 'w', encoding='utf-8') as f:
            f.write(consciousness_api_code)
    ...
    def wait_for_services(self):
        ...
        print("🤖 HACK-MEMORI Auto-Generation: ACTIVE")
